...
describe('gen-tool-catalog collectToolCatalog', () => {
  it('boots every shipped tool package and harvests its model-facing schemas', async () => {
    ...
    expect(names).toEqual([
      ...
      'list_subagent_models', 'load_workspace_dependencies', 'lsp', 'ocr_image', 'plugin_manager', 'present', 'pwsh', 'pwsh', 'ralph',
      ...
      'update_goal', 'vision_describe', 'wait_agent', 'web_fetch', 'web_search', 'workflow', 'write',
    ])
